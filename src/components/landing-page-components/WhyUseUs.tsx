...
export default function WhyUseUs() {
    const clipboardIcon = <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M14.3503 2H9.65025C8.61025 2 7.76025 2.84 7.76025 3.88V4.82C7.76025 5.86 8.60025 6.7 9.64025 6.7H14.3503C15.3903 6.7 16.2303 5.86 16.2303 4.82V3.88C16.2403 2.84 15.3903 2 14.3503 2Z" fill="#4326C4" />
    ...
    const peopleBenefits: Data[] = [
        {
            ...
            subtitle: 'Our organization comprises of leaders in the transport business with over 40 years experience.',
            icon: clipboardIcon
        },
        {
            title: 'Personal Contact',
            subtitle: 'Customer support and various means of communication available to take care of your professional needs.',
            icon: clipboardIcon
        },
        {
    ...
    return <section className={styles.why_use_us}>
