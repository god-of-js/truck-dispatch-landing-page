  ...
  const benefits = [
    {
      ...
      subtitle:
        "Assigned trips are pre-paid, with payment processing handled seamlessly and automatically. Once you submit the loading proof, payment is swiftly initiated, ensuring a hassle-free experience for you.",
    },
    {
      img: RockHand,
      title: "Less admin work",
      subtitle:
        "We will go through cumbersome tender processes for you! Pick the routes that fit you best without the administrative hassle. This way, you can grow sustainably while avoiding transport packages that you are not 100% comfortable with.",
    },
    {
      img: Woohhoo,
      title: "Plan your transports",
      subtitle:
        "View all transports assigned to you in a detailed manner to assist in planning. this helps you plan better by understanding each transport's details and timing. This way, you can use your resources, time, and efforts wisely, making sure everything goes smoothly.",
    },
    {
      img: Diamond,
      title: "Deals",
      subtitle:
        "Engage in a wide array of advantageous opportunities, including but not limited to enticing referral bonuses, exclusive promotions, and a plethora of other enticing deals. ",
    },
  ];
  ...
  const howItWorks = [
    {
      title: "Get Started",
      subtitle:
        "Register as either a transporter or a transport company to access carrier benefits.",
      icon: (
    ...
    },
    {
      title: "Bid For Jobs",
      subtitle:
        "Bid for trips broadcasted to the network with your own pricing and stand a chance to be considered by the responsible shipper",
      icon: (
        <svg viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="vuesax/bold/verify">
            <g id="verify">
    ...
    },
    {
      title: "Get Assigned",
      subtitle:
        "If the shipper is okay with your profile, he may either negotiate or make full payment through our platform. An email would be sent to notify you that you have been selected.",
      icon: (
        <svg viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="vuesax/bold/verify">
            <g id="verify">
    ...
    },
    {
      ...
      subtitle:
        "After been assigned and loading the trip, submit the loading proof as a video after which payment would be approved by the responsible shipper.",
      icon: (
        <svg viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="vuesax/bold/verify">
            <g id="verify">
    ...
    },
    {
      ...
      subtitle:
        "Update trip details to keep the shipper notified, get Transfer delivery order, e.t.c through our powerful dashboard.",
      icon: (
        <svg viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="vuesax/bold/verify">
            <g id="verify">
    ...
    },
    {
      title: "Complete trip",
      subtitle:
        "Complete the trip to notify the shipper that his trip has been completed, get rated and reviews by the shipper. Thank you in advance for helping us with our trip.",
      icon: (
        <svg viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
          <g id="vuesax/bold/verify">
            <g id="verify">
    ...
    <>
      ...
      <div className={styles.shippers_page}>
        <HeroSection
          ...
          subtitle="Access a wide range of loads, enjoy fast payments, streamline administrative tasks, and efficiently manage your fleet."
        />
        <section className={styles.benefits}>
          <header>
            <h2>
              Exclusive benefits <br /> for Transporters
            </h2>
          ...
          <div className={styles.benefits__list}>
            ...
            <div className={styles.get_started}>
              <div className={styles.content}>
                <p>
                  Start enjoying better working experience & transport solutions
                  tailored for you.
                </p>
