    ...
    <>
      ...
      <main>
        ...
        <section className={`${styles['page-width']} ${styles['client-user-type-group']}`}>
          ...
          <div className={styles['user-type']}>
            ...
            <div className={styles['user-type__details']}>
              ...
              <a href="https://dashboard.gettruckdispatch.com/auth/join/shipper">
          ...
          <div className={`${styles['user-type']} ${styles['invert']}`}>
            ...
            <div className={styles['user-type__details']}>
              ...
              <a href="https://dashboard.gettruckdispatch.com/auth/join/company">
        ...
        <section className={`${styles['page-width']} ${styles['service-user-type-group']}`}>
          ...
          <div className={`${styles['user-type']}`}>
            ...
            <div className={styles['user-type__details']}>
              ...
              <a href="https://dashboard.gettruckdispatch.com/auth/join/transportCompany">
        ...
        <section className={styles["contact-us"]}>
          <div className={styles["page-width"]}>
            <div className={`${styles["contact-us__card"]}`}>
              <div className={styles["get-in-touch"]}>Get in Touch with Us!</div>
              <div className={styles["action-links"]}>
                <a href="mailto:support@gettruckdispatch.com">{chatIcon} send us an email</a>
                <a href="tel:+2347045404102">{callIcon} Call us directly: +234 704 5404 102</a>
              </div>
            </div>
          </div>
        </section>
        <section className={styles["faqs-container"]}>
          <div className={`${styles['page-width']} ${styles["faqs"]}`}>
            <div className={styles["faqs-hero-section"]}>
