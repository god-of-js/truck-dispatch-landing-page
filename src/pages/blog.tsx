  ...
  return (
    <>
      ...
      <div className={styles.main}>
        <header>
          <h1>
            Latest news and tips <br /> from TruckDispatch
          </h1>
        </header>
        ...
        <div className={styles.posts}>
          <div className={styles.empty_content}>
                ...
                <svg viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  <g id="vuesax/bold/document-copy">
                    <g id="document-copy">
                      ...
                      <path
                        id="Vector_3"
                        d="M9.98014 5.14999C9.67014 4.83999 9.14014 5.04999 9.14014 5.47999V8.1C9.14014 9.2 10.0701 10.1 11.2101 10.1C11.9201 10.11 12.9101 10.11 13.7601 10.11C14.1901 10.11 14.4101 9.61 14.1101 9.31C13.0201 8.22 11.0801 6.26999 9.98014 5.14999Z"
                      />
                    </g>
                  </g>
                </svg>
            ...
            <div>
              ...
              <p>
                Keep your eyes on this space for educational content on the
                trucking industry and updates on Truckdispatch.
              </p>
            </div>
          </div>
        </div>
