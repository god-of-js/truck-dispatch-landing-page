...
export default function AboutUs() {
    const whyTruckDispatch = [
        ...
        },
        {
            ...
            subtitle: 'Our network consists of vetted transporters with numerous years of experience in the field. This reduces risk and unprofessionalism. Can’t take our word for it? View the ratings and remarks of each transporter when you look into their profile.',
            icon: <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <g id="vuesax/bold/truck">
                    <g id="truck">
                        <path id="Vector" d="M12 0.92V9.23C12 10.25 11.17 11.08 10.15 11.08H1C0.45 11.08 0 10.63 0 10.08V3.69C0 1.65 1.65 0 3.69 0H11.07C11.59 0 12 0.41 12 0.92Z" fill="#4326C4" />
                        <path id="Vector_2" d="M19.5 13.5C19.78 13.5 20 13.72 20 14V15C20 16.66 18.66 18 17 18C17 16.35 15.65 15 14 15C12.35 15 11 16.35 11 18H9C9 16.35 7.65 15 6 15C4.35 15 3 16.35 3 18C1.34 18 0 16.66 0 15V13C0 12.45 0.45 12 1 12H10.5C11.88 12 13 10.88 13 9.5V4C13 3.45 13.45 3 14 3H14.84C15.56 3 16.22 3.39 16.58 4.01L17.22 5.13C17.31 5.29 17.19 5.5 17 5.5C15.62 5.5 14.5 6.62 14.5 8V11C14.5 12.38 15.62 13.5 17 13.5H19.5Z" fill="#4326C4" />
                        <path id="Vector_3" d="M6 20C7.10457 20 8 19.1046 8 18C8 16.8954 7.10457 16 6 16C4.89543 16 4 16.8954 4 18C4 19.1046 4.89543 20 6 20Z" fill="#4326C4" />
                        <path id="Vector_4" d="M14 20C15.1046 20 16 19.1046 16 18C16 16.8954 15.1046 16 14 16C12.8954 16 12 16.8954 12 18C12 19.1046 12.8954 20 14 20Z" fill="#4326C4" />
                        <path id="Vector_5" d="M20 10.53V12H17C16.45 12 16 11.55 16 11V8C16 7.45 16.45 7 17 7H18.29L19.74 9.54C19.91 9.84 20 10.18 20 10.53Z" fill="#4326C4" />
                    </g>
                </g>
            </svg>
            ...
            <div className={styles.about_us}>
                ...
                <section className={styles.company_profile}>
                    <div className={styles.company_profile__content}>
                        ...
                        <p>
                            Recognizing the imperative need for solutions, he embarked on a mission to optimize the industry by leveraging their extensive family network of experienced transporters, which collectively spans over 40 years of freight expertise.</p>
